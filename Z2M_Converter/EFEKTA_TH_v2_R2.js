...
const definition = {
        ...
        model: 'EFEKTA_TH_v2',
        vendor: 'EfektaLab',
        description: 'EFEKTA_TH_v2 - Smart temperature and humidity sensors. The device is equipped with a remote temperature sensor SHTC3/SHT20/SHT30/SHT40. Thermostat and hygrostat.',
        fromZigbee: [fz.temperature, fz.humidity, fz.battery, fzLocal.termostat_config, fzLocal.hydrostat_config, fzLocal.node_config, fzLocal.uptime],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting.bind(endpointOne, coordinatorEndpoint, ['genTime', 'genPowerCfg', 'msTemperatureMeasurement', 'msRelativeHumidity']);
